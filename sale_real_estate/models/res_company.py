...
class ResCompany(models.Model):
    ...
    legal_representative1 = fields.Many2one('res.partner', 'Legal Representative 1')
    legal_representative2 = fields.Many2one('res.partner', 'Legal Representative 2')
    legal_representative3 = fields.Many2one('res.partner', 'Legal Representative 3')
